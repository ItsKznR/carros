    ...
    <main>
      <section>
        ...
        <div className="bg-green">
          ...
          <h2>SUVs</h2>
          <p>Escolha um SUV pelo seu interior espaçoso, poder e versatilidade. Perfeito para passar as férias em familia ou para aventuras off-road.</p>
          <a href="https://webmotors.com.br/suvs" target="_blank">Ver mais</a>
        </div>
        ...
        <div className="bg-dark-green">
          ...
          <a href="https://webmotors.com.br/carros-de-luxo" target="_blank">Ver mais</a>
        </div>
      </section>
    </main>
  )
